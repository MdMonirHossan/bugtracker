...
class BugAdmin(admin.ModelAdmin):
    list_display    = ['id', 'title', 'description', 'status', 'priority', 'assigned_to', 'project', 'created_by', 'created_at', 'updated_at']
...
class CommentAdmin(admin.ModelAdmin):
    list_display    = ['id', 'bug', 'commenter', 'message', 'created_at', 'updated_at']
